...
// --- Definisikan tipe untuk props DynamicContent ---
 ...
 * Komponen ini sekarang menggunakan tipe props yang jelas (React.FC).
 */
const DynamicContent: React.FC<DynamicContentProps> = ({ title, description, imageUrl }) => {
  return (
    <div className="bg-[#F5F5F7] dark:bg-neutral-800 p-8 md:p-14 rounded-3xl mb-4">
      ...
      {/* Mengganti <img> dengan <Image> dari Next.js untuk optimasi.
        Perhatikan: `width` dan `height` harus berupa angka, bukan string.
      */}
      <Image
        src={imageUrl}
        alt={title}
  ...
  },
  {
    ...
    content: (
      <DynamicContent
        ...
        imageUrl="https://assets.aceternity.com/ipad.png"
      />
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <DynamicContent
        ...
        imageUrl="https://assets.aceternity.com/iphone.png"
      />
    ),
  },
];
